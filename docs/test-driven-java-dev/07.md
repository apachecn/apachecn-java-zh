...
为了更好地了解流是什么、做什么以及不做什么，强烈建议阅读 Oracle 的流页面。一个好的起点是[https://docs.oracle.com/javase/8/docs/api/java/util/stream/Stream.html](https://docs.oracle.com/javase/8/docs/api/java/util/stream/Stream.html) 。
