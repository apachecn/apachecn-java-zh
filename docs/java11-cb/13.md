...
您至少需要安装 JDK 8 才能使用这些较新的库，本章中的示例使用 Java 10 及以后版本支持的语法。如果需要，可以直接在 JShell 中运行这些代码段。您可以使用 JShell 访问[第 12 章](12.html)*阅读评估打印循环（REPL），*了解更多关于 JShell 的信息。
