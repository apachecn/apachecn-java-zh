...
![](Images/8e04a14e-0ee4-454f-ab59-77b7b52500fa.jpg)
...
![](Images/adc5e088-75aa-4700-a19e-18a933b4725f.jpg)
...
![](Images/4475e788-f329-4f3f-b7ae-dad19dbd83a7.jpg)
...
![](Images/aeb8a942-20e4-4ae4-b5c2-f4ab4aca8499.png)

您将看到控制台发出启动消息。最后，JUnit 将反映测试结果，如下所示：

![](Images/99043fcd-d743-4357-bab9-11aa1fdb232b.png)
...
![](Images/74d4a555-4b66-497f-8f7e-6ff1f20354f2.png)
...
![](Images/2927cb7b-c5d5-4c0a-bca2-d78fe6dd75bf.png)

8.  在`site`文件夹中，点击`index.html`；您将看到以下报道：

![](Images/c10de181-60d7-476e-aa69-57ce441e6297.png)

9.  通过对`product`包的调查，您可以看到`ProductService`只覆盖了`24%`，如下图所示：

![](Images/a3cb7b70-a1fb-4bc9-88cd-612d0f4af2bf.png)

10.  原因是我们在服务中只涉及了`getProduct`API。`insertProduct`和`updateProduct`未涵盖。以下屏幕截图中的向下钻取报告显示了这一点：

![](Images/5d010c06-257b-4370-b8ea-fa9de6bc6d7c.png)

11.  在`getProduct`方法中，覆盖是完整的。这是因为，在两个场景中，我们讨论了快乐路径和错误条件：

![](Images/bb6b3bad-be68-4019-b44f-c45e330552ea.png)

12.  另一方面，您会发现我们没有涵盖`ExceptionHandler`类中的分支，如下所示：

![](Images/508a5194-6c30-4d13-8780-6d7da4326ab2.png)
