...
![](Images/d05a49d3-1c19-438f-afdd-9759f8202244.png)
...
![](Images/d9570efd-e76c-4132-9c6e-bbc5d2386b57.png)
...
![](Images/681949d8-038d-4675-9be2-8e5a65d86c5a.png)

2.  选择 Maven 项目：

![](Images/9fe14540-94a8-4cd4-b7fe-156e2d293869.png)

3.  在向导的下一个窗口中，选择“创建简单项目”。

4.  下一个对话框将询问许多参数。其中，组 Id（项目名称）和工件 Id（应用程序或服务名称）非常重要。选择合理的名称，如以下屏幕截图所示：

![](Images/1c3962d4-41d2-4a1f-9fda-56f35f23a737.png)

5.  选择 Finish。您应该看到以下结构：

![](Images/f7096253-de5c-4104-ac43-57ab9881fb77.png)
...
![](Images/43dfa29c-079f-4a17-b400-375158b121f4.png)
...
![](Images/e48d02a3-1d11-4c87-b0f6-933b6155d8a2.png)
...
![](Images/517a372f-2512-46ef-8db3-44f2e63bac93.png)
...
![](Images/43947a81-a87d-47cb-832f-a0a4ecb0893c.png)
...
![](Images/c0613d40-8b94-4e8b-8f03-81ba4ddbd6cc.png)
...
![](Images/432ff7ef-5eb6-4cc5-9810-9280b967d0e7.png)

3.  创建一个类似于我们为`product`项目创建的应用程序类。注意注释。注释`@EnableEurekaServer`将 Eureka 作为一项服务启动：

![](Images/f1c9c5e9-be4a-4332-8242-c5a24e496291.png)
...
![](Images/aa53f30d-18e5-46f3-b83d-342370af2aec.png)

启动完成后，访问`localhost:8761`上的 Eureka 服务器，查看是否进入以下页面：

![](Images/be32fc66-1a70-47a3-bad5-8d633506d118.png)
...
![](Images/582a3747-c882-43dd-a428-9c5e34411f9b.png)
...
![](Images/397e1c42-3d6c-424c-9012-305e71f783ae.png)

4.  现在，像以前一样启动`product`服务：

![](Images/8e4e43cc-a802-441d-b9ba-0f169af84c0c.png)

在`product`服务初始化结束时，您将看到向 Eureka 服务器注册服务的日志语句。

要检查`product`服务是否已注册，请刷新您刚刚访问的 Eureka 服务器页面：

![](Images/2c653d48-c5d6-4702-83bf-e03c58e5131b.png)
...
![](Images/a120da92-e357-4c87-a464-4497467711cd.png)

2.  创建一个`ProductClient`类，该类只监听`/client`并在查找后将请求转发到实际的`product`服务：

![](Images/a9340beb-00a1-47e4-b71f-2fd7ebcb4681.png)
...
![](Images/da08bf22-4652-47b9-bdc4-29a5a359104e.png)
...
![](Images/e6bb7836-fac8-4b95-a37b-c562d0d4fd4c.png)
...
![](Images/9624f0d6-6e69-49df-9d35-0988accb12c2.png)

2.  运行`ProductSpringApp`类（或者在`product`项目上运行 Maven 构建）。请注意日志中的最后几行：

![](Images/57e4b508-31d3-4563-985e-2fa5b451d62e.png)
