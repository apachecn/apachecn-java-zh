...
![](Images/0be37779-2ac3-4fe6-b8b0-0177c19149f4.jpg)
...
![](Images/698bfbdf-e24d-4703-83cb-1b21d38d35d6.png)
...
![](Images/5c64f4a0-c9ab-449a-b532-60689a27ebee.png)

在 Azure 门户中选择应用程序服务

2.  单击添加链接：

![](Images/e6202b0e-c4fd-4cfa-a12d-ee7ccaea74c1.png)

3.  接下来，单击 Web 应用程序链接，如图所示：

![](Images/57ceb8b3-0323-43aa-a803-952ff68d76b0.png)

通过 Azure 门户|应用程序服务|添加导航选择 Web 应用程序。

4.  单击 Create 按钮链接，您将看到以下页面

![](Images/96ccf874-4146-47f3-a6ab-61dea5d877f9.png)

5.  我们为我们的`product`API 填写详细信息。我已将 App name 填写为`ch10product`并将其他选项保留为默认值。

6.  接下来，单击页面底部的“创建”按钮。

![](Images/528a954f-768a-4c27-b9bf-621c7a73c88a.png)

这将导致创建应用程序服务。

7.  我们点击 App Services 下的`ch10product`，进入菜单：

![](Images/0b09eccf-5511-4d37-afbc-0dccd115d72d.png)

8.  请注意应用程序部署的 URL 和 FTP 主机名。我们需要在两个位置更改应用程序设置和部署凭据：

![](Images/9ee26222-3971-4748-9a66-eb98829c466e.png)
...
![](Images/4f3d3759-f319-4833-8895-7cb58e3e9f81.png)

10.  接下来，我们单击左侧的 Deployment credentials 链接。在这里，我们捕获 FTP/部署用户名和密码，以便能够将应用程序推送到主机，并单击保存，如以下屏幕截图所示：

![](Images/58881a11-bdbb-4016-af39-bc577133c1e6.png)
...
![](Images/e713d0dd-11a7-45b5-8ed9-c05e45d445be.png)
...
![](Images/ddabfc10-2db1-410f-b43b-25921443cd22.png)

2.  在`Web App for Containers`的新搜索下：

![](Images/22d28f9f-ef11-48b2-864d-19bb66be4724.png)

3.  选择容器的 Web 应用程序后，单击创建，如图所示：

![](Images/72ab0c88-bdfe-4b2c-9cf0-f4f6a8e158ea.png)
...
![](Images/6112a303-5635-4575-91b3-cad71f75e9b7.png)

选择通过 Azure 门户导航创建|新建|搜索`Web App for Containers`

5.  这将导致创建应用程序服务：

![](Images/3e41b4f7-c4cf-400e-ae94-2a12bdd29694.png)
...
![](Images/94c17e67-6c28-4522-be1d-2fd4c65f88d9.png)

可以访问主机 docker 应用程序的 URL

7.  我们可以看到我们的`product`API 在浏览器中运行：

![](Images/b933045b-f5a6-4d37-8d26-f7c24d7e92e4.png)
...
![](Images/c73b090b-cac7-4dc8-97cf-82ac59cb3602.png)

我们输入以下值：

![](Images/6d4da0c7-148a-496c-b4c4-5ee8fa099559.png)
...
![](Images/762646ef-8399-4f28-bdfc-49974a7a83d8.png)

加入 Linux 群集：

![](Images/af50ebad-5369-40ef-8aa6-ff410a3c9442.png)

我们将被引导到包含集群详细信息的页面。集群可用一小时。

默认情况下，某些端口处于打开状态。当我们部署`product`API 应用程序时，我们可以在端口`8080`上访问相同的应用程序：

![](Images/35514f7b-5a6a-4802-9d95-b424e11c1b36.png)
...
![](Images/87f2fbfc-96ce-4174-8c61-ad8d59454d50.png)
...
![](Images/e4fbf658-89f7-4ef1-91c7-c66006a45afa.png)
...
![](Images/dcabf483-0ca5-42dc-8ca1-0ad0a1bf313b.png)

# 潜入代码

如果我们深入研究代码，我们可以看到定义了默认函数`hello`的主代码文件：

![](Images/7bf8fd82-eea1-4f5f-915e-4dc7ccf22afd.png)
