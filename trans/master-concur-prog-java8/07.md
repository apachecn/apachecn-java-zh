...
![Comparing the solutions](../images/00019.jpeg)

最后，在第三种方法中，我们使用查询结果生成一个 HTML 网页。这些是查询`james bond`的第一个结果：

![Comparing the solutions](../images/00020.jpeg)

对于查询`gone with the wind`，以下是第一个结果：

![Comparing the solutions](../images/00021.jpeg)

最后，这些是查询`rocky`的第一个结果：

![Comparing the solutions](../images/00022.jpeg)
