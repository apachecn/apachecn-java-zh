...
我们在第 1 章*Java 入门 12*中简要介绍了异常。在本章中，我们将更系统地讨论这个问题。Java 中有两种异常：checked 异常和 unchecked 异常。两者都将被演示，并解释两者之间的区别。读者还将了解与异常处理相关的 Java 构造的语法以及处理异常的最佳实践。本章将以可用于调试生产代码的断言语句的相关主题结束。
