...
但是，您不需要自己管理连接池。有几种成熟的框架可以为您做到这一点，比如 HikariCP（[https://brettwooldridge.github.io/HikariCP](https://brettwooldridge.github.io/HikariCP)、Vibur（[http://www.vibur.org](http://www.vibur.org)）和公共 DBCP（[https://commons.apache.org/proper/commons-dbcp](https://commons.apache.org/proper/commons-dbcp)——可靠，使用方便。
