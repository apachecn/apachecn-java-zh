...
如果你想阅读更多关于微服务的文章，第一个也是最真实的来源是 martinfowler 的文章（[http://www.martinfowler.com/articles/microservices.html](http://www.martinfowler.com/articles/microservices.html)）。请注意，此页面引用了 Microservices 资源指南，其中列出了许多 Microservices 信息资源。
