...
随着 java8 的引入，Java 发生了巨大的变化，这个变化随着新版本 java9 以及 java10 和 11 被提升到了一个全新的水平。Java 有着悠久的历史，已经有 20 多年的历史了，但同时，它是新的、功能性的、反应式的和性感的。这是一种开发人员喜爱的语言，同时也是许多企业项目开发人员语言的首选。
...
第 1 章“Java 11 入门”，为您提供 Java 入门，帮助您在计算机上安装 Java，并使用新的 Jshell 运行第一个交互式程序。
