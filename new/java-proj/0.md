...
[第 2 章](0.html)、*第一个真正的 Java 程序-排序名称*，教您如何创建开发项目。我们将创建程序文件并编译代码。

[第 3 章](0.html)、*优化分拣代码专业*，进一步开发代码，使代码可重用，不仅是玩具。
...
[第 7 章](0.html)*使用 REST*构建一个商业 Web 应用程序，带领您完成一个具有许多商业应用程序特性的应用程序的开发。我们将使用标准的 REST 协议，它已经在企业计算领域取得了进展。
...
这本书的代码包也托管在 GitHub 上的[https://github.com/PacktPublishing/Java-Projects](https://github.com/PacktPublishing/Java-Projects)。如果代码有更新，它将在现有 GitHub 存储库中更新。
