...
*   **servlet**：在 Java 中，`javax.servlet.Filter`（[http://docs.oracle.com/javaee/7/api/javax/servlet/Filter.html](http://docs.oracle.com/javaee/7/api/javax/servlet/Filter.html)用于过滤请求或响应。`doFilter`方法还接收过滤链作为参数，并将请求传递给其他方法。
