...
JNLP 用于使用 Web 服务器上的资源在桌面客户机上启动应用。JNLP 客户机包括 JavaWebStart 和 Java 插件软件，因为它们能够启动远程托管的 Applet。该协议有助于启动 RIA。
...
如果您指出 JNLP 客户机不支持的应用类型，那么您的应用启动将失败。有关 JNLP 的更多信息，[请参阅官方文档](https://docs.oracle.com/javase/7/docs/technotes/guides/javaws/developersguide/faq.html)。
